package com.example.animationdemo.ui.settings
...
import com.example.animationdemo.databinding.FragmentSettingsBinding
...
class SettingsFragment : Fragment() {
    ...
    private fun animateView(view: View) {
        ...
        circularReveal.addListener(object : AnimatorListenerAdapter() {
            override fun onAnimationEnd(animation: Animator) {
                val intent = Intent(this@SettingsFragment.context, TopupActivity::class.java)
